#!/bin/bash -l
#SBATCH --job-name=t29d_s42
#SBATCH --partition=gpu-l4-24g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t29d_s42_%j.log
#SBATCH --error=logs/t29d_s42_%j.err

# T29d: 3ch Official + Actn2 + IndependentChannelAdapter (seed=42)
...
echo "============================================"
echo "T29d: 3ch + Actn2 + Adapter (L4, seed=42)"
...
python src/train.py --config src/config/t29d_adapter_3ch_actn2.yaml
TRAIN_EXIT=$?
