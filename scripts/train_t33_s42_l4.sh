#!/bin/bash -l
#SBATCH --job-name=t33_s42_l4
#SBATCH --partition=gpu-l4-24g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t33_s42_l4_%j.log
#SBATCH --error=logs/t33_s42_l4_%j.err

# ============================================
# T33: CellFinder Head-Only Adaptation (L4, seed=42)
#
...
# Result: checkpoints/T33_CellFinder_HeadOnly_seed42_*/
# ============================================
...
echo "============================================"
echo "T33: CellFinder Head-Only (L4, seed=42)"
...
python tools/train_cellfinder.py --seed 42 --epochs 200 --patience 20 --batch-size 4
TRAIN_EXIT=$?
