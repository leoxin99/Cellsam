#!/bin/bash -l
#SBATCH --job-name=t29c_s123_a100
#SBATCH --partition=gpu-a100-80g
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t29c_s123_a100_%j.log
#SBATCH --error=logs/t29c_s123_a100_%j.err

# T29c: 3ch Official + Actn2, SEED=123
...
echo "============================================"
echo "T29c: Official 3ch + Actn2 (A100, seed=123)"
