#!/bin/bash -l
#SBATCH --job-name=t33g_dcm_q35_s42_a100
#SBATCH --partition=gpu-a100-80g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t33g_dcm_q35_s42_a100_%j.log
#SBATCH --error=logs/t33g_dcm_q35_s42_a100_%j.err
...
echo "============================================"
echo "T33g dapi_cm candidate-aware q35 (A100, seed=42)"
...
python tools/train_cellfinder_candidate_aware.py \
    ...
    --output-dir "checkpoints/T33g_CandidateAware_dapicm_strict_q35_f1p03_seed42_A100_$(date +%Y%m%d_%H%M%S)"
