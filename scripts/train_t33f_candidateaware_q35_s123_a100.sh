#!/bin/bash -l
#SBATCH --job-name=t33f_q35_s123_a100
#SBATCH --partition=gpu-a100-80g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t33f_q35_s123_a100_%j.log
#SBATCH --error=logs/t33f_q35_s123_a100_%j.err
...
echo "============================================"
echo "T33f candidate-aware q35 (A100, seed=123)"
...
python tools/train_cellfinder_candidate_aware.py \
    ...
    --output-dir "checkpoints/T33f_CandidateAware_adaptive_strict_q35_f1p03_seed123_A100_$(date +%Y%m%d_%H%M%S)"
