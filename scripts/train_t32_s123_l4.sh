#!/bin/bash -l
#SBATCH --job-name=t32_s123_l4
#SBATCH --partition=gpu-l4-24g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t32_s123_l4_%j.log
#SBATCH --error=logs/t32_s123_l4_%j.err

# ============================================
# T32: Stage2-like Neck-Only Baseline (L4, seed=123)
#
...
# Result: checkpoints/T32_NeckOnly_Baseline_seed123_*/
# ============================================
...
echo "============================================"
echo "T32: Neck-Only Baseline (L4, seed=123)"
...
python src/train.py --config src/config/t32_stage2_like_neck_only.yaml --seed 123
TRAIN_EXIT=$?
