#!/bin/bash -l
#SBATCH --job-name=t30_s42_l4
#SBATCH --partition=gpu-l4-24g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t30_s42_l4_%j.log
#SBATCH --error=logs/t30_s42_l4_%j.err

# T30: LoRA on Encoder Q/V (BF-only, seed=42)
# Checkpoint dir: T30_LoRA_QV_BF_seed42_YYYYMMDD_HHMMSS
...
echo "============================================"
echo "T30: LoRA Q/V BF-only (L4, seed=42)"
echo "Job ID: $SLURM_JOB_ID"
echo "GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader)"
echo "Start: $(date)"
echo "============================================"

EXP_PREFIX="T30_LoRA_QV_BF_seed42"
BEFORE_DIRS=$(ls -d checkpoints/${EXP_PREFIX}_* 2>/dev/null | sort)

python src/train.py --config src/config/t30_lora_qv_bf.yaml --seed 42
TRAIN_EXIT=$?
