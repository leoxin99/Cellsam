#!/bin/bash -l
#SBATCH --job-name=t27a_a100
#SBATCH --partition=gpu-a100-80g
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t27a_a100_%j.log
#SBATCH --error=logs/t27a_a100_%j.err

# ============================================
# T27a: Plan B Decoder-Only Fine-Tuning (A100)
#
...
echo "============================================"
echo "T27a: Plan B Decoder-Only (A100)"
