#!/bin/bash -l
#SBATCH --job-name=t29b_s123_a100
#SBATCH --partition=gpu-a100-80g
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/t29b_s123_a100_%j.log
#SBATCH --error=logs/t29b_s123_a100_%j.err

# T29b: 3ch Official Encoding, SEED=123
# Checkpoint dir: T29b_Official_3ch_seed123_YYYYMMDD_HHMMSS
...
echo "============================================"
echo "T29b: Official 3ch (A100, seed=123)"
echo "Job ID: $SLURM_JOB_ID"
echo "GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader)"
echo "Start: $(date)"
echo "============================================"

EXP_PREFIX="T29b_Official_3ch_seed123"
BEFORE_DIRS=$(ls -d checkpoints/${EXP_PREFIX}_* 2>/dev/null | sort)

python src/train.py --config src/config/t29b_official_3ch.yaml --seed 123
TRAIN_EXIT=$?
