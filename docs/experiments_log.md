...
## E33: GT Box + Ԥѵ�� CellSAM Baseline (2026-02-06) 

**Ŀ��**: ����**��΢��**�Ļ���ָ�꣬�������ĶԱ�

**ʵ������**:
- **����**: data/processed/images/*.npy (10241024, 3ͨ�� [BF, DAPI, Actn2])
- **Prompt**: GT Box (�� GT mask �� regionprops ��ȡ)
- **ģ��**: Ԥѵ�� CellSAM (��΢��)
- **������**: 5
- **����ϸ����**: 60
...
| ָ�� | ֵ | ˵�� |
|------|-----|------|
| **Instance Dice** | **0.350** | ��ϸ���߽羫�� |
| Instance Dice Std | 0.145 | ����ϴ� |
| Semantic Dice | 0.789 | ���ؼ��ص� |
| Semantic Dice Std | 0.034 | - |
| GT Cells/Image | 12.0 | - |
| Pred Cells/Image | 12.0 | ����=ϸ���� (��Ϊ��GT��) |

**����**:
- Semantic Dice 0.79 �������������� Instance Dice ֻ�� 0.35
- ˵��Ԥѵ��ģ��ȱ���ļ�ϸ���߽�ѧϰ
- **΢���ļ�ֵ**: ���΢���� Instance Dice > 0.35��֤��΢����Ч

**����**:  Baseline �ѽ�����Instance Dice 0.35 Ϊ΢��Ŀ���ṩ�ο���
