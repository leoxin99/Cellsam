...
\textbf{Locked metrics under the same protocol.}
On \texttt{test73}, the selected route reports \texttt{F1 = 0.6172} and \texttt{PQ = 0.3981}. On \texttt{val71}, the corresponding values are \texttt{F1 = 0.6143} and \texttt{PQ = 0.3906}. The close val/test behavior supports protocol stability at current scale.
