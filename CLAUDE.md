...
### ⚠️ 已废弃方案
- **E15b 多通道** (BF+DAPI+Actn2): 分割结果全屏单色，无效
...
| 日期 | 更新内容 |
|-----|---------|
| **2026-01-16** | **添加 AMP 混合精度到 train.py**，添加边界平滑 (sigma=5)，❌ 废弃 E15b 多通道方案 |
| 2026-01-15 | E15a/E15b 多通道实验，E15b Pixel Dice 0.7454 低于 E12 |
| **2026-01-14** | **E14 智能扩展策略 +3.3% Dice**，核-细胞轴向对齐分析 (50%@30°) |
| **2026-01-13** | 检测与训练策略分析，Actn2 过滤非心肌细胞核 |
| **2026-01-12** | 创建 project_diary.md 日志系统，框尺寸阈值讨论 |
| 2026-01-11 | E12 边界损失微调 PQ↑265%，分水岭实验失败，文档管理方案 |
| 2026-01-10 | 验证指标优化方案 (PQ, AJI, Rand Index) |
| 2026-01-09 | 实例级分割实现，DAPI 检测替换 CellFinder |
| 2026-01-08 | 类别不平衡修复 (Dice 0→0.52)，全管线测试 |
...
| 日期 | 决策 | 原因 |
|------|------|------|
| **2026-01-16** | **废弃多通道 E15b** | 分割结果全屏单色，模型未学到通道信息 |
| **2026-01-16** | **继续使用 E12** | BF×3 输入效果好，Pixel Dice 0.7718 |
