"""Compute F1/P/R for all existing experiment result JSONs that have TP/FP/FN."""
import json
import glob
import os
...
print(f"{'Experiment':<45} {'Key':<12} {'PQ':>6} {'SQ':>6} {'RQ':>6} {'F1':>6} {'P':>6} {'R':>6} {'BM':>6} {'AJI':>6} {'TP':>4} {'FP':>4} {'FN':>4} {'N':>3}")
print("-" * 140)
for r in results:
    exp = r['file'].split('/')[1] if '/' in r['file'] else r['file']
    print(f"{exp:<45} {r['key']:<12} {r['PQ']:>6.4f} {r['SQ']:>6.4f} {r['RQ']:>6.4f} {r['F1']:>6.4f} {r['P']:>6.4f} {r['R']:>6.4f} {r['BM_Dice']:>6.4f} {r['AJI']:>6.4f} {r['TP']:>4} {r['FP']:>4} {r['FN']:>4} {r['n']:>3}")
