...
from ...AnchorDETR.util.misc import (
    NestedTensor,
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        topk_values, topk_indexes = torch.topk(
            prob.view(out_logits.shape[0], -1), num_queries, dim=1
        )
        scores = topk_values
